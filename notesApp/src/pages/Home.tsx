  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-indigo-600 p-6">
      <div className="text-center max-w-2xl text-white">
        ...
        <button
          className="w-full px-6 py-3 mt-4 text-purple-600 bg-white border border-purple-600 rounded-lg shadow-md
          hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-400"
          onClick={() => {
